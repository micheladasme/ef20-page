...
function Banner() {
    return (
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-32 relative bg-cover bg-center bg-no-repeat bg-scroll sm:bg-origin-content sm:bg-contain sm:bg-top sm:bg-fixed"
