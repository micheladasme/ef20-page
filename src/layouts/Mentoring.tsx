...
function Mentoring() {
    return (
        <>
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-t  from-black via-gray-900 to-black" id="mentoring">
            <div className="container px-4 md:px-6 mx-auto">
                ...
                <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-gray-400">Mentoria 1 a 1 para crear un portafolio de criptomonedas.</p>
                    </div>
                    <div className="flex flex-col items-center text-center">
